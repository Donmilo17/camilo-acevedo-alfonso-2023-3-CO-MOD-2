...
from dino_runner.components.powerups_manager import PowerUpManager
...
class Game:
    ...
    def show_menu(self):
        ...
        if self.death_count == 0:
            ...
            self.menu.draw(self.screen, f"Score: {self.score.count}", half_screen_width, 3800)
            self.menu.draw(self.screen, f"Deaths: {self.death_count.count}", half_screen_width, 415)
            self.menu.draw(self.screen, f"Higest Score: {self.highest_score.count}", half_screen_width, 510)
