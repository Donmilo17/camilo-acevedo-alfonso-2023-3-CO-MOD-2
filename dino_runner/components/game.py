...
class Game:
    ...
    def show_menu(self):
        ...
        if self.death_count == 0:
            ...
            self.menu.draw(self.screen, f"Score: {self.score.count}", half_screen_width, 400)
            self.menu.draw(self.screen, f"Deaths: {self.death_count.count}", half_screen_width, 420)
